...
SRC_URI="mirror://ruby/${MY_P}.tar.bz2
		http://a3li.li/~alex/gentoo/distfiles/${PN}-patches-${PV}.tar.bz2"
...
pkg_postinst() {
	...
	elog
	elog "It's expected that Ruby 1.9 have rubygems and rake installed."
	elog "You may want to install dev-ruby/rubygems and dev-ruby/rake"
	elog
}
