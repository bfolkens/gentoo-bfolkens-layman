...
# $Header: /var/cvsroot/gentoo-x86/dev-lang/ruby/ruby-1.9.3_p194-r1.ebuild,v 1.11 2012/12/07 21:43:09 ago Exp $

EAPI=4

# Maintener notes:
# - Falcon patches are available on
#   https://github.com/wayneeseguin/rvm/tree/master/patches/ruby
#
...
ncurses +readline +yaml falcon-patch" #libedit
...
src_prepare() {
	...
	use falcon-patch && epatch "${FILESDIR}/${P}-falcon.patch"
